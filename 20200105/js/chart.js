...
function progressPieChart(progressPieChartData) {
    var myChart = echarts.init(document.getElementById('chart_3'));
    var data = progressPieChartData;
...
function rosePieChart(roseData) {
...
function drawChart() {
    let lineChartData = [randomArr(4, 0, 60), randomArr(4, 0, 60)]
    let barChartData = [
        randomArr(3, 10, 20),
        randomArr(3, 20, 40),
        randomArr(3, 40, 60)
    ];
    let progressPieChartData = [{
        name: '今日在所',
    ...
    let barData = randomArr(5, 100, 600);
    let roseData = randomArr(3, 40, 200);
    lineChart(lineChartData);
    barChart(barChartData);
    triaBarChart(barData);
    rosePieChart(roseData);
    progressPieChart(progressPieChartData);
}
drawChart();
d3.select("svg")
    .selectAll("g.module")
...
var numRun2 = $("#num2").numberAnimate({
    num: '21345',
    speed: 2000,
    symbol: ","
});
